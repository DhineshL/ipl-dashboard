package io.dhinesh.ipldashboard.data;
...
public class BatchConfig {
 ...
 private final String[] FIELDS_NAMES = new String[] { "id", "city", "date", "player_of_match", "venue", "neutral_venue",
 ...
 public FlatFileItemReader<MatchInput> reader() {
  return new FlatFileItemReaderBuilder<MatchInput>().name("MatchItemReader")
    .resource(new ClassPathResource("matchdata.csv")).delimited().names(FIELDS_NAMES)
